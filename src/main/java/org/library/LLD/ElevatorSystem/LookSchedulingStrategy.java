...
public class LookSchedulingStrategy implements SchedulingStrategy {
    ...
    public int getNextStop(Elevator elevator) {
        ...
        Queue<Request> requests = elevator.getRequestsQueue();
        ...
        Request primaryRequest = requests.peek();
        ...
        for (Request req : requests) {
            ...
            if (travelDirection == Direction.UP && reqFloor > currentFloor && reqFloor <= primaryFloor) {
                ...
                if (req instanceof InternalRequest
                        || (req instanceof ExternalRequest && ((ExternalRequest)req).getDirection() == Direction.UP)) {
                ...
                // DOWN.
                if (req instanceof InternalRequest
                        || (req instanceof ExternalRequest && ((ExternalRequest)req).getDirection() == Direction.DOWN)) {
